	...
	<body>	
		...
		<div class="row page" width="290mm" height="210mm">
			<div width="140mm" style="background-color:#FFFF99;  border:15px solid #FF000D; border-radius:10px 0px 0px 10px; padding:3px; padding-bottom:12px;">
				...
				<img src="<?=base_url()?>uploads/<?=$va->sign?>" style="width:120px;height:35px;margin-left:370px;margin-top:20px;"><br>
			...
			<div width="140mm" style="background-color:#FFFF99;  border:15px solid #FF000D; border-radius:0px 10px 10px 0px; padding:3px; padding-bottom:12px;">
				...
				<img src="<?=base_url()?>mar/img/logo/logo-bs4.png" align="center"  style="margin:-10mm 50mm 0 60mm; width:80px;"><br>
				
				<img src="<?=base_url()?>mar/img/gallery/gallery-1.jpg" style="width:60mm; margin:-2mm 0 0 5mm; border-radius:0 50%;">
				
				<img src="<?=base_url()?>mar/img/gallery/gallery-1.jpg" style="width:60mm; margin:-2mm 5mm 0 0mm; float:right; border-radius:50% 0;">
				
				
				
				<h6 align="center" style="color:white;background-color:red; margin-top:15px;margin-left:-5px;margin-right:-5px; padding:5px 23px;">LAXMI MATA EDUCATIONAL SOCITY, SUNDAR NAGAR, RAIPUR (C.G.)</h6>
								...
								<div class="col-md-12">
									...
									<div class="row-md-4" style="background-color:white; font-style:verdana; border-radius:10px; height:50mm; margin:15px 3px 10px 10px;  width:139mm;">
										<div class="container-fluid">
											...
											<img src="<?=base_url()?>uploads/<?=$s?>" style="width:110px;height:30px">
											
											<img src="<?=base_url()?>uploads/<?=$p?>" style="width:110px;height:30px; margin-left:60px;">
									...
									<div class="row-md-4" style="background-color:white; font-style:verdana; border-radius:10px; height:52mm; margin:15px 3px 10px 10px;  width:139mm;">
										<div class="container-fluid">
											...
											<hr style="margin-top:-15px;">
											<p style="color:purple;font-size:12px;font-weight:bold; float:right;">
												PROMOTED TO CLASS:<span style="font-size:14px;  margin-left:22px;"><input type="text" style=" width: 25px; border: none; background: transparent; align: center"></span>
