								...
								<div class="row">
									...
									<div class="col-md-8 offset-md-2">
										...
										<div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Enquiry Form no. : <span class="text-danger">*</span></label>
											<div class="col-md-6">
                                                                                            <input type="text" id="fname" name="enquiry" placeholder="Form no." data-parsley-group="step-1" data-parsley-required="true" class="form-control" />
											</div>
										</div>
										<!-- end form-group -->
										<!-- begin form-group -->
										<div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Admission no. : <span class="text-danger">*</span></label>
											<div class="col-md-6">
												<input type="text" id="lname" name="admission" placeholder="Admission no." data-parsley-group="step-1" data-parsley-required="true" class="form-control" />
											</div>
										</div>
										<!-- end form-group -->
										<!-- begin form-group -->
										<div class="form-group row m-b-10">
											...
											<div class="col-md-6">
												<input type="text" id="date" name="class" placeholder="Class" data-parsley-group="step-1" data-parsley-required="true" class="form-control" />
											</div>
										</div>
										<!-- end form-group -->
										<!-- begin form-group -->
										<div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Session : <span class="text-danger">*</span></label>
											<div class="col-md-6">
										...
										<div class="form-group row m-b-10">
											...
											<div class="col-md-9">
												<input type="text"id="adress" name="name" placeholder="Address " class="form-control m-b-10" />
											...
											<div class="col-md-9">
												<input type="date"id="adress" name="date" placeholder="Address " class="form-control m-b-10" />
											...
											<div class="col-md-9">
												<input type="text"id="adress" name="fname" placeholder="Address " class="form-control m-b-10" />
											...
											<div class="col-md-9">
												<input type="text"id="adress" name="mname" placeholder="Address " class="form-control m-b-10" />
											...
											<div class="col-md-9">
												<input type="text"id="adress" name="occupation" placeholder="Address " class="form-control m-b-10" />
												
											</div>
										</div>
                                                                                <div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Contact no. : :<span class="text-danger">*</span></label>
											<div class="col-md-9">
												<input type="text"id="adress" name="phone" placeholder="Address " class="form-control m-b-10" />
												
											</div>
										</div>
                                                                                <div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Permanent Adress : :<span class="text-danger">*</span></label>
											<div class="col-md-9">
                                                                                            <textarea name="padress" cols="3" rows="5" placeholder="Permanent Address " class="form-control m-b-10" ></textarea>
												<!--<input type="text"id="adress" name="padress" placeholder="Permanent Address " class="form-control m-b-10" />-->
												
											</div>
										</div>
                                                                                <div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">City :<span class="text-danger">*</span></label>
											<div class="col-md-9">
												<input type="text"id="adress" name="city" placeholder="City" class="form-control m-b-10" />
												
											</div>
										</div>
                                                                                <div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Pincode :<span class="text-danger">*</span></label>
											<div class="col-md-9">
												<input type="text"id="adress" name="pincode" placeholder="pincode" class="form-control m-b-10" />
												
											</div>
										</div>
                                                                                <div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">P.O : :<span class="text-danger">*</span></label>
											<div class="col-md-9">
												<input type="text"id="adress" name="po" placeholder="p.o " class="form-control m-b-10" />
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-md-8 md-offset-2">
										...
										<!-- begin form-group -->
										<div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Local Adress <span class="text-danger">*</span></label>
											<div class="col-md-9">
												<textarea name="ladress" cols="3" rows="5" placeholder="LOcal Address " class="form-control m-b-10" ></textarea>
											</div>
										</div>
										<!-- end form-group -->
										<!-- begin form-group -->
										<div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">City <span class="text-danger">*</span></label>
											<div class="col-md-9">
												<input type="text" name="lcity" id="email" placeholder="someone@example.com" class="form-control" data-parsley-group="step-2" data-parsley-required="true" data-parsley-type="email" />
											</div>
										</div>
                                                                                <div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Pincode <span class="text-danger">*</span></label>
											<div class="col-md-9">
												<input type="number" name="lpincode" id="email" placeholder="someone@example.com" class="form-control" data-parsley-group="step-2" data-parsley-required="true" data-parsley-type="email" />
											</div>
										</div>
                                                                                <div class="form-group row m-b-10">
											<label class="col-md-3 col-form-label text-md-right">Pincode <span class="text-danger">*</span></label>
