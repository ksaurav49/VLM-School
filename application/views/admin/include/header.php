...
else if(strcmp($pname,"empv")==0)
{
    $class8='active';
}
else if(strcmp($pname,"emp")==0)
{
    $class8='active';
}
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand"><span class="navbar-logo"></span> <b>VLM - </b> Admin</a>
				...
				<!--		<ul class="sub-menu">
						...
						<a href="<?=base_url()?>se">
						    ...
						    <span>Student Managment</span>
                                        ...
                                        <li class="has-sub <?=$class11?>">
						<a href="<?=base_url()?>evmn">
					        <!--<b class="caret"></b>-->
						    <i class="fa fa-question-circle" style="font-size:18px"></i>
						    <span>Evaluation Managment</span>
					    </a>
					    ...
					    <ul class="sub-menu">
					        <li><a href="<?=base_url()?>emp">New Employee</a></li>
					        <li><a href="<?=base_url()?>empv">View Employee</a></li>
					    </ul>
					</li>
