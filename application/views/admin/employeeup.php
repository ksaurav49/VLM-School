                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body">
                            <?php
                                ...
                                $r= $this->db->query("select * from employee where id='$id'");
                                   foreach ($r->result() as $row)
                                    {
                                
                                ?>
                            <form action="<?= base_url()?>AdminSideController/salaryupem/<?=$id?>" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true" name="demo-form">
                                
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Name :</label>
									<div class="col-md-8 col-sm-8">
                                                                            <input class="form-control" type="text" id="fullname" name="name" value="<?=$row->name?>" disabled="" data-parsley-required="true"  />
									</div>
								</div>
                                                                <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Occupation Type. :</label>
									<div class="col-md-8 col-sm-8">
                                                                            <input class="form-control" placeholder="Enter Phone umber" type="text" id="fullname" name="phone" value="<?=$row->type?>" disabled="" data-parsley-required="true"  />
									</div>
								</div>
                                                                <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Salary :</label>
									<div class="col-md-8 col-sm-8">
                                                                            <input class="form-control" type="text" placeholder="Enter Adress" id="fullname" name="salary" value="<?=$row->salary?>" data-parsley-required="true"  />
									</div>
								</div>
