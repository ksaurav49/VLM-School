...
<?php// include'include/header.php';?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Evaluation Management</a></li>
				<li class="breadcrumb-item active">Manage Evaluation...</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Evaluation Management <small>Manage Evaluation...</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-lg-8">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Manage Evaluation...</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                           
                            <form action="<?= base_url()?>AdminSideController/evalSubmit" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true" name="demo-form">
                                
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Select Term :</label>
									<div class="col-md-8 col-sm-8">
                                                                            <select id="subjectClass" name="term" class="form-control" style="background-color:#626263;"required>
									...
									<div class="col-md-8 col-sm-8">
                                                                            <input class="form-control" placeholder="Enter Examination name" type="text" id="fullname" name="name"  data-parsley-required="true"  />
									</div>
								</div>
                                                                <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Weightage in Percent(%) :</label>
									<div class="col-md-8 col-sm-8">
                                                                            <input class="form-control" type="number" placeholder="Enter Weightage" id="fullname" name="weight"  data-parsley-required="true"  />
									</div>
								</div>
